...
if __name__ == "__main__":
    ...
    result = classify(API_URL, "./samples/Tomato_1001.jpg")
    print(f"Prediction: {result['class_name']} ({result['confidence']:.2%})")

    sim = similarity(API_URL, "./samples/Tomato_1001.jpg", "./samples/Tomato_1001.jpg")
    print(f"Similarity same image: {sim['similarity_percentage']:.1f}%")

    sim = similarity(API_URL, "./samples/Tomato_1001.jpg", "./samples/Bitter_Gourd_1201.jpg")
