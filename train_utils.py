...
### Сохранение метрик для их оценки
def save_metrics(history, best_val_acc, test_acc, model_type, config_info, save_path=METRICS_PATH):
    ...
    with open(save_path, 'w', encoding='utf-8') as f:
        ...
        f.write(f"Best Validation Loss: {history['val_loss'][best_epoch - 1]:.6f}\n")
        f.write(f"Corresponding Training Accuracy: {history['train_acc'][best_epoch - 1]:.2f}%\n")
        f.write(f"Corresponding Training Loss: {history['train_loss'][best_epoch - 1]:.6f}\n")
